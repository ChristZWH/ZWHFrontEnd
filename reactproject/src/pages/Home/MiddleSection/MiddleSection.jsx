...
const useImgChange = (imgInfomation) => {
    // 图片轮播
    ...
    function currentImg() {
        return (
            imgInfomation.map((item) => <li key={item.id} className={item.id === currentIndex && 'active'}></li>)
        )
    }
    useEffect(() => {
...
function MiddleSection() {
    ...
    const [handleMiddle2Enter, handleMiddle2Leave, currentIndex, currentImg, handlePreClick, handleNextClick] = useImgChange(imgInfomation)
    ...
    return (
        ...
        <div className="middle relative">
            ...
            <div className="middle3">
                ...
                <div>
                    <button><Link to="/chat">点击聊天</Link></button>
                </div>
